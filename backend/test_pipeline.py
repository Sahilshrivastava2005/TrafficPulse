...
def run_pipeline():
    ...
    fp = os.path.join(os.path.dirname(__file__), "..", "data", "Astram event data_anonymized.csv.csv")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "..", "data", "processed_parking_congestion_data.csv")
